import { MinimalKeyboardEvent } from "../logic/doc-manager";
...
export function eventsFromEventCreator(c: EventCreator): EventWithHandler[] {
  return c.kind === EventCreatorKind.FromKeys
